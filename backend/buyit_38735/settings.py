"""
Django settings for buyit_38735 project.
...
WSGI_APPLICATION = 'buyit_38735.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "buyit_38735 API",
    "DESCRIPTION": "API documentation for buyit_38735 App",
    "VERSION": "v1",
}
